...
.filter(n => typeof n === 'number' && isFinite(n) && n => n < 11 && n => Number.isInteger(n))
...
const students = [
    {name: 'Jonas', marks: [88, 'asd', 10, 2], },
    {name: 'Maryte', marks: [99, true, 8, 6], },
    {name: 'Petras', marks: [66, [], Infinity, 7, 7, 7, 7, 7], },
    {name: 'Ona', marks: [77, null, undefined, {}, 2, 4, 6, 8, 10], 
},
]
/*
Vardenis1: 2; 
...
.map(student => (
    {
        ...
        average: student.marks.reduce ((t, n) => t + n, 0) / student.marks.length,
    }
))
